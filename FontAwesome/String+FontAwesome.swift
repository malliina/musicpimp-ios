...
extension String {
  ...
  public static var enumDictionary: [String: FAIcon] {
    return [
  ...
  public static var fontAwesomeUnicodeStrings: [String] {
    return [
      "\u{f000}", "\u{f001}", "\u{f002}", "\u{f003}", "\u{f004}", "\u{f005}", "\u{f006}",
      "\u{f007}", "\u{f008}", "\u{f009}", "\u{f00a}", "\u{f00b}", "\u{f00c}", "\u{f00d}",
      "\u{f00e}", "\u{f010}", "\u{f011}", "\u{f012}", "\u{f013}", "\u{f014}", "\u{f015}",
      "\u{f016}", "\u{f017}", "\u{f018}", "\u{f019}", "\u{f01a}", "\u{f01b}", "\u{f01c}",
      "\u{f01d}", "\u{f01e}", "\u{f021}", "\u{f022}", "\u{f023}", "\u{f024}", "\u{f025}",
      "\u{f026}", "\u{f027}", "\u{f028}", "\u{f029}", "\u{f02a}", "\u{f02b}", "\u{f02c}",
      "\u{f02d}", "\u{f02e}", "\u{f02f}", "\u{f030}", "\u{f031}", "\u{f032}", "\u{f033}",
      "\u{f034}", "\u{f035}", "\u{f036}", "\u{f037}", "\u{f038}", "\u{f039}", "\u{f03a}",
      "\u{f03b}", "\u{f03c}", "\u{f03d}", "\u{f03e}", "\u{f040}", "\u{f041}", "\u{f042}",
      "\u{f043}", "\u{f044}", "\u{f045}", "\u{f046}", "\u{f047}", "\u{f048}", "\u{f049}",
      "\u{f04a}", "\u{f04b}", "\u{f04c}", "\u{f04d}", "\u{f04e}", "\u{f050}", "\u{f051}",
      "\u{f052}", "\u{f053}", "\u{f054}", "\u{f055}", "\u{f056}", "\u{f057}", "\u{f058}",
      "\u{f059}", "\u{f05a}", "\u{f05b}", "\u{f05c}", "\u{f05d}", "\u{f05e}", "\u{f060}",
      "\u{f061}", "\u{f062}", "\u{f063}", "\u{f064}", "\u{f065}", "\u{f066}", "\u{f067}",
      "\u{f068}", "\u{f069}", "\u{f06a}", "\u{f06b}", "\u{f06c}", "\u{f06d}", "\u{f06e}",
      "\u{f070}", "\u{f071}", "\u{f072}", "\u{f073}", "\u{f074}", "\u{f075}", "\u{f076}",
      "\u{f077}", "\u{f078}", "\u{f079}", "\u{f07a}", "\u{f07b}", "\u{f07c}", "\u{f07d}",
      "\u{f07e}", "\u{f080}", "\u{f081}", "\u{f082}", "\u{f083}", "\u{f084}", "\u{f085}",
      "\u{f086}", "\u{f087}", "\u{f088}", "\u{f089}", "\u{f08a}", "\u{f08b}", "\u{f08c}",
      "\u{f08d}", "\u{f08e}", "\u{f090}", "\u{f091}", "\u{f092}", "\u{f093}", "\u{f094}",
      "\u{f095}", "\u{f096}", "\u{f097}", "\u{f098}", "\u{f099}", "\u{f09a}", "\u{f09b}",
      "\u{f09c}", "\u{f09d}", "\u{f09e}", "\u{f0a0}", "\u{f0a1}", "\u{f0f3}", "\u{f0a3}",
      "\u{f0a4}", "\u{f0a5}", "\u{f0a6}", "\u{f0a7}", "\u{f0a8}", "\u{f0a9}", "\u{f0aa}",
      "\u{f0ab}", "\u{f0ac}", "\u{f0ad}", "\u{f0ae}", "\u{f0b0}", "\u{f0b1}", "\u{f0b2}",
      "\u{f0c0}", "\u{f0c1}", "\u{f0c2}", "\u{f0c3}", "\u{f0c4}", "\u{f0c5}", "\u{f0c6}",
      "\u{f0c7}", "\u{f0c8}", "\u{f0c9}", "\u{f0ca}", "\u{f0cb}", "\u{f0cc}", "\u{f0cd}",
      "\u{f0ce}", "\u{f0d0}", "\u{f0d1}", "\u{f0d2}", "\u{f0d3}", "\u{f0d4}", "\u{f0d5}",
      "\u{f0d6}", "\u{f0d7}", "\u{f0d8}", "\u{f0d9}", "\u{f0da}", "\u{f0db}", "\u{f0dc}",
      "\u{f0dd}", "\u{f0de}", "\u{f0e0}", "\u{f0e1}", "\u{f0e2}", "\u{f0e3}", "\u{f0e4}",
      "\u{f0e5}", "\u{f0e6}", "\u{f0e7}", "\u{f0e8}", "\u{f0e9}", "\u{f0ea}", "\u{f0eb}",
      "\u{f0ec}", "\u{f0ed}", "\u{f0ee}", "\u{f0f0}", "\u{f0f1}", "\u{f0f2}", "\u{f0a2}",
      "\u{f0f4}", "\u{f0f5}", "\u{f0f6}", "\u{f0f7}", "\u{f0f8}", "\u{f0f9}", "\u{f0fa}",
      "\u{f0fb}", "\u{f0fc}", "\u{f0fd}", "\u{f0fe}", "\u{f100}", "\u{f101}", "\u{f102}",
      "\u{f103}", "\u{f104}", "\u{f105}", "\u{f106}", "\u{f107}", "\u{f108}", "\u{f109}",
      "\u{f10a}", "\u{f10b}", "\u{f10c}", "\u{f10d}", "\u{f10e}", "\u{f110}", "\u{f111}",
      "\u{f112}", "\u{f113}", "\u{f114}", "\u{f115}", "\u{f118}", "\u{f119}", "\u{f11a}",
      "\u{f11b}", "\u{f11c}", "\u{f11d}", "\u{f11e}", "\u{f120}", "\u{f121}", "\u{f122}",
      "\u{f122}", "\u{f123}", "\u{f124}", "\u{f125}", "\u{f126}", "\u{f127}", "\u{f128}",
      "\u{f129}", "\u{f12a}", "\u{f12b}", "\u{f12c}", "\u{f12d}", "\u{f12e}", "\u{f130}",
      "\u{f131}", "\u{f132}", "\u{f133}", "\u{f134}", "\u{f135}", "\u{f136}", "\u{f137}",
      "\u{f138}", "\u{f139}", "\u{f13a}", "\u{f13b}", "\u{f13c}", "\u{f13d}", "\u{f13e}",
      "\u{f140}", "\u{f141}", "\u{f142}", "\u{f143}", "\u{f144}", "\u{f145}", "\u{f146}",
      "\u{f147}", "\u{f148}", "\u{f149}", "\u{f14a}", "\u{f14b}", "\u{f14c}", "\u{f14d}",
      "\u{f14e}", "\u{f150}", "\u{f151}", "\u{f152}", "\u{f153}", "\u{f154}", "\u{f155}",
      "\u{f156}", "\u{f157}", "\u{f158}", "\u{f159}", "\u{f15a}", "\u{f15b}", "\u{f15c}",
      "\u{f15d}", "\u{f15e}", "\u{f160}", "\u{f161}", "\u{f162}", "\u{f163}", "\u{f164}",
      "\u{f165}", "\u{f166}", "\u{f167}", "\u{f168}", "\u{f169}", "\u{f16a}", "\u{f16b}",
      "\u{f16c}", "\u{f16d}", "\u{f16e}", "\u{f170}", "\u{f171}", "\u{f172}", "\u{f173}",
      "\u{f174}", "\u{f175}", "\u{f176}", "\u{f177}", "\u{f178}", "\u{f179}", "\u{f17a}",
      "\u{f17b}", "\u{f17c}", "\u{f17d}", "\u{f17e}", "\u{f180}", "\u{f181}", "\u{f182}",
      "\u{f183}", "\u{f184}", "\u{f185}", "\u{f186}", "\u{f187}", "\u{f188}", "\u{f189}",
      "\u{f18a}", "\u{f18b}", "\u{f18c}", "\u{f18d}", "\u{f18e}", "\u{f190}", "\u{f191}",
      "\u{f192}", "\u{f193}", "\u{f194}", "\u{f195}", "\u{f196}",
      /* Font Awesome ver 4.10 */
      "\u{f1b9}", "\u{f19c}", "\u{f1b4}", "\u{f1b5}", "\u{f1e2}", "\u{f1ad}", "\u{f1ba}",
      "\u{f1b9}", "\u{f1ae}", "\u{f1ce}", "\u{f1db}", "\u{f1cb}", "\u{f1b2}", "\u{f1b3}",
      "\u{f1c0}", "\u{f1a5}", "\u{f1bd}", "\u{f1a6}", "\u{f1a9}", "\u{f1d1}", "\u{f199}",
      "\u{f1ac}", "\u{f1c6}", "\u{f1c7}", "\u{f1c9}", "\u{f1c3}", "\u{f1c5}", "\u{f1c8}",
      "\u{f1c1}", "\u{f1c5}", "\u{f1c5}", "\u{f1c4}", "\u{f1c7}", "\u{f1c8}", "\u{f1c2}",
      "\u{f1c6}", "\u{f1d1}", "\u{f1d3}", "\u{f1d2}", "\u{f1a0}", "\u{f19d}", "\u{f1d4}",
      "\u{f1dc}", "\u{f1da}", "\u{f19c}", "\u{f1aa}", "\u{f1cc}", "\u{f1ab}", "\u{f1cd}",
      "\u{f1cd}", "\u{f1cd}", "\u{f19d}", "\u{f19b}", "\u{f1d8}", "\u{f1d9}", "\u{f1dd}",
      "\u{f1b0}", "\u{f1a7}", "\u{f1a8}", "\u{f1a7}", "\u{f1d6}", "\u{f1d0}", "\u{f1d0}",
      "\u{f1b8}", "\u{f1a1}", "\u{f1a2}", "\u{f1d8}", "\u{f1d9}", "\u{f1e0}", "\u{f1e1}",
      "\u{f198}", "\u{f1de}", "\u{f1be}", "\u{f197}", "\u{f1b1}", "\u{f1bc}", "\u{f1b6}",
      "\u{f1b7}", "\u{f1a4}", "\u{f1a3}", "\u{f1cd}", "\u{f1ba}", "\u{f1d5}", "\u{f1bb}",
      "\u{f19c}", "\u{f1ca}", "\u{f1d7}", "\u{f1d7}", "\u{f19a}", "\u{f19e}",
      /* Font Awesome ver 4.20 */
      "\u{f209}", "\u{f1fe}", "\u{f1fa}", "\u{f1f6}", "\u{f1f7}", "\u{f206}", "\u{f1e5}",
      "\u{f1fd}", "\u{f207}", "\u{f1ec}", "\u{f20a}", "\u{f1f3}", "\u{f1f2}", "\u{f1f1}",
      "\u{f1f4}", "\u{f1f5}", "\u{f1f0}", "\u{f1f9}", "\u{f1fb}", "\u{f1e3}", "\u{f1ee}",
      "\u{f20b}", "\u{f208}", "\u{f202}", "\u{f203}", "\u{f201}", "\u{f20c}", "\u{f1ea}",
      "\u{f1fc}", "\u{f1ed}", "\u{f200}", "\u{f1e6}", "\u{f20b}", "\u{f20b}", "\u{f1e7}",
      "\u{f1e3}", "\u{f204}", "\u{f205}", "\u{f1f8}", "\u{f1e4}", "\u{f1e8}", "\u{f1eb}",
      "\u{f1e9}",
    ]
  }
