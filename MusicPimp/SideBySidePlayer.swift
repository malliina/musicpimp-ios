...
class SideBySidePlayer: ContainerParent {
  ...
  override var currentFooterHeight: CGFloat { 66 }
  override var preferredPlaybackFooterHeight: CGFloat { 66 }
  ...
  func updateNavbar() {
    ...
    navigationItem.rightBarButtonItems =
      (queueVc.navigationItem.rightBarButtonItems ?? [])
      + (playerVc.navigationItem.rightBarButtonItems ?? [])
  }
