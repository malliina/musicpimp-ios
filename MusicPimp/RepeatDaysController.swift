...
class RepeatDaysController: BaseTableController {
    ...
    -> UITableViewCell
  {
    ...
    let accessory =
      isChecked(row) ? UITableViewCell.AccessoryType.checkmark : UITableViewCell.AccessoryType.none
  ...
  override func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
    ...
    if let cell = tableView.cellForRow(at: indexPath) {
      ...
      let newAccessory =
        wasChecked ? UITableViewCell.AccessoryType.none : UITableViewCell.AccessoryType.checkmark
