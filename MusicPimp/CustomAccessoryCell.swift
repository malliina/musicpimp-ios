...
class CustomAccessoryCell: PimpCell {
  ...
  static let trackAccessory = UIImage(named: "more_filled_grey-100.png")!.withSize(
    scaledToSize: accessoryImageSize)
  static let disclosureAccessory = UIImage(named: "chevron-right-100.png")!.withSize(
    scaledToSize: disclosureIndicatorSize)
  ...
  func installDisclosureAccessoryView(height: CGFloat = CustomAccessoryCell.defaultCellHeight) {
    self.accessoryView = createAccessory(
      height: height, image: CustomAccessoryCell.disclosureAccessory)
  }
